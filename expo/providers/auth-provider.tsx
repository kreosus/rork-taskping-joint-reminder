...
function sanitizeUser(candidate: StoredUserCandidate): AppUser | null {
  ...
  return { id: candidate.id, name: candidate.name, provider: candidate.provider, identifier, createdAt: candidate.createdAt };
}
